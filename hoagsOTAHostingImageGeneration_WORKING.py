...
#                   Validity    Pattern     Checksum   CompImgLen   OrgImgLen     ENVsize       RSVD2      RSVD3
...
def add_header_to_bin_file(i_file_path, envFile, o_file_path):
...
def main():
    ...
    add_header_to_bin_file(inputFw, inputEnv, outputImage)
